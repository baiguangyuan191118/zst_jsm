...
public class PwdInputController extends LinearLayout {
    ...
    public PwdInputController(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * 获取宽高
     */
    private OnPreDrawListener listener = new OnPreDrawListener() {
    ...
    private void initView(AttributeSet attrs) {
        ...
        default_textSize = SizeUtils.px2sp(default_textSize);
        typedArray.recycle();
    }
    ...
    private void drawPwdInput() {
        ...
        for (int i = 0; i < default_input_count; i++) {
            ...
            LayoutParams parms = new LayoutParams(textW, height);
            ...
            if (i < default_input_count - 1) {
                ...
                LayoutParams lineParams = new LayoutParams(1, height);
