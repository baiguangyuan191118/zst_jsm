...
public class EyeEditText extends AppCompatEditText implements OnFocusChangeListener,
        TextWatcher {
    // 眼睛按钮的引用
    ...
    private void init() {
        mEyeCloseDrawable = getResources().getDrawable(
                R.mipmap.ic_pwd_eye_close);
        mEyeOpenDrawable = getResources().getDrawable(R.mipmap.ic_pwd_eye_on);
