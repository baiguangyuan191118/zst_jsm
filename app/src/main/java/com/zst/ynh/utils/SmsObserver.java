...
public class SmsObserver extends ContentObserver {
	...
	public SmsObserver(Handler handler) {
		...
		appName = JsmApplication.getContext().getResources().getString(R.string.app_name);
	}
...
//		super.onChange(selfChange);
	...
	public void getSmsFromPhone() {
		ContentResolver cr = JsmApplication.getInstance().getContentResolver();
		...
		if (cur.moveToNext()) {
			...
			if (body != null && body.contains(appName) && body.contains("验证码")) {
